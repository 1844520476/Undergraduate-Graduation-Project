...
class Detections:
    ...
    def save(self, save_dir='output/detect/exp'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'output/detect/exp', mkdir=True)  # increment save_dir
        self.display(save=True, save_dir=save_dir)  # save results

    def crop(self, save=True, save_dir='output/detect/exp'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'output/detect/exp', mkdir=True) if save else None
