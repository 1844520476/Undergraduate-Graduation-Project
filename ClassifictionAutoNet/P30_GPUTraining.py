...
logs_save = rf'Output/demo/0328'
pt_save_name = 'Output/pt/demo'
...
# 数据集准备
train_data = torchvision.datasets.CIFAR10("./Dataset/data_Cifar10", train=True,
                                          transform=torchvision.transforms.ToTensor(), download=True)
test_data = torchvision.datasets.CIFAR10("./Dataset/data_Cifar10", train=False,
                                         transform=torchvision.transforms.ToTensor(), download=True)
...
# 利用dataloader加载数据集
train_dataloader = DataLoader(train_data, batch_size=BatchSize_train)
test_dataloader = DataLoader(test_data, batch_size=BatchSize_test)
