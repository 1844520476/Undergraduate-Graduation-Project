...
def run(data,
        ...
        project=ROOT / 'output/val',  # save to project/name
...
def parse_opt():
    ...
    #TODO: weights path
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'output/train/exp4/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default=ROOT / 'output/val', help='save to project/name')
...
# python val.py --data data/mask_data.yaml --weights output/train/exp_yolov5s/weights/best.pt --img 640
